...
import { authenticate, signInWithGoogle, signInWithGitHub } from '@/app/actions/auth';
...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-green-50 to-white dark:from-green-950 dark:to-black px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md">
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
          Não tem uma conta?{" "}
          <Link href="/registro" className="font-medium text-green-600 hover:text-green-500 dark:text-green-400">
            Criar conta grátis
          </Link>
        </p>
      </div>
